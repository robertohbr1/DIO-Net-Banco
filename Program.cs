...
namespace DIO.Bank
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Conta minhaConta = new Conta(TipoConta.PessoaFisica, 0, 0, "Roberto");            
        ...
        private static void ListarContas()
        {
            ...
            {
                Console.WriteLine("Nenhuma Conta");
                return;
            }
        ...
        private static string ObterOpcaoUsuario()
        {
            ...
            Console.WriteLine("Informe a opção abaixo:");

            Console.WriteLine("1 - Listar");
            Console.WriteLine("2 - Inserir");
            Console.WriteLine("3 - Transf");
